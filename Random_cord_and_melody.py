...
import math
# from Setting_change import *
def generate_melody_from_cord(cord,duration,cord_octave=3, note_octave=4):
    global note_durations, note_duration_prob

    pitches = [12*(note_octave-cord_octave)+pitch for pitch in cord]
...
def random_cord_and_melody(instrument,cord_octave=3, note_octave=4):
    ...
    while True:
        ...
        melody = generate_melody_from_cord(cord,duration,cord_octave,note_octave)
        if not isGap:
...
if __name__=="__main__":
    ...
    # print(cords)
    # print(notes)
    # key,cords,notes = change_scale(cords,notes,key,'C#')
    # print(cords)
    # print(notes)
